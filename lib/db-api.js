...
function reportError(res, message)
{
	...
	res.json({err: message, data: null})
}
...
function count(req, res)
{
	...
	res.json({err: getLastError(), data: count})
}
...
function find(req, res)
{
	...
	res.json({err: getLastError(), data: docs})
}
...
function findOne(req, res)
{
	...
	res.json({err: getLastError(), data: doc || null})
}
...
function insert(req, res)
{
	...
	res.json({err: getLastError(), data: id || null})
}
...
function remove(req, res)
{
	...
	res.json({err: getLastError(), data: numRemoved})
}
...
function update(req, res)
{
	...
	res.json({err: getLastError(), data: numUpdated})
}
...
function save(req, res)
{
	...
	res.json({err: getLastError(), data: true})
}
