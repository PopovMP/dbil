...
/*
<update> = {
	? $inc   : {filed: delta,   ...}, // Increments the field with delta or creates a field equal to delta
	? $push  : {filed: value,   ...}, // Pushes a value to an array filed
	? $rename: {filed: newName, ...}, // Renames a field
	? $set   : {filed: value,   ...}, // Sets a new value to a filed or creates a new field
	? $unset : {filed: bool,    ...}, // Deletes a field
}
*/
